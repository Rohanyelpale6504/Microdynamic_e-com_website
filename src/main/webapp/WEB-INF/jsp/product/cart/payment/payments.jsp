...
<body>
    <div class="container">
        ...
        <div class="paper-container">
            ...
            <div class="paper">
                <form action="${pageContext.request.contextPath}/addcarts" method="post">
                    <div class="form-field">
                        <input type="hidden" id="totalpayment" name="totalpayment" value="${payment.totalpayment}" readonly>
                    </div>
                    <div class="form-field">
                        <input type="hidden" id="paymenttype" name="paymenttype" value="${payment.paymenttype}" readonly>
                    </div>
                    <div class="form-field">
